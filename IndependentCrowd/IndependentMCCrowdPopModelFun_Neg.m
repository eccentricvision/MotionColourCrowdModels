function [modout,errorval] = IndependentMCCrowdPopModelFun_Neg(EP,MP,data)
%IndependentMCCrowdPopModelFun_Neg
%
%function [modout,errorval] = IndependentMCCrowdPopModelFun_Neg(ExParam,ModParam)
...
ColTarNegTotal    = 0;
ColFlankPeakTotal = 1;
ColFlankNegTotal  = 0;%1; %turn off negative component for colour
