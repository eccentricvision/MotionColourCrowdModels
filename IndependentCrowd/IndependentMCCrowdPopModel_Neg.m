...
%free parameters
ModParam.DirNoise  = 0.0126;
ModParam.ColNoise  = 0.0057;
ModParam.LateNoise = 0.0408;

NumFreeParam = 3;

%% run the model

[modout,errval] = IndependentMCCrowdPopModelFun_Neg(ExParam,ModParam,DataPoolPropMean);
toc
