%IndependentMCCrowdPopModel_NoNeg
%model to predict Michael's motion-colour conjoint crowding data
%v5.2 for both colour and motion, without inhibitory parameters
%
...
%free parameters
ModParam.DirNoise  = 0.0353;
ModParam.ColNoise  = 0.0038;
ModParam.LateNoise = 0.0713;

NumFreeParam = 3;

%% run the model

[modout,errval] = IndependentMCCrowdPopModelFun_NoNeg(ExParam,ModParam,DataPoolPropMean);
toc
