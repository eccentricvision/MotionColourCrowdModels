...
%Best thus far (fine fit, August 2018 v5.1):
% Err1= 0.3956
% 
%     NumTrialsPerStim: 1024
%          DirExciteSD: 65.3691
%             DirNegSD: 0.0100
%         DirWFPosPeak: 0.5943
%         DirWFNegPeak: 0
...
ModParam.DirExciteSD  = 65.3691;%85.7825;
ModParam.DirNegSD     = 0.01;%85.4421;%0.01;%85.5523

ModParam.DirWFPosPeak = 0.5069;%0.5069;%0.5943;%0.7066;
ModParam.DirWFNegPeak = 0;%0.7337;%0;%1
ModParam.DirWFPosSD   = 70.8827;%61.0577;%65.9759;%
ModParam.DirWFNegSD   = 0.01;%76.2126;%0.01;%334.7418
ModParam.DirWFNegDelT = 0;%238.5886;

ModParam.ColExciteSD = 65.2458;%62.8753;%
ModParam.ColNegSD    = 0.01;%0.01; 

ModParam.ColWFPosPeak = 0.2358;%0.2518;
ModParam.ColWFNegPeak = 0;%0;
ModParam.ColWFPosSD   = 124.6079;%147.0333;
ModParam.ColWFNegSD   = 0.01;%0.01;
ModParam.ColWFNegDelT = 0;

%free parameters
ModParam.DirNoise  = 0.0192;% 0.0116;%0.0262;
ModParam.ColNoise  = 0.0090;%0.0030;%0.0041;
ModParam.LateNoise = 0.1879;%0.1448;%0.0908;

NumFreeParam = 3;

%% run the model

[modout,errval] = CombinedMCCrowdPopModelFun(ExParam,ModParam,DataPoolPropMean);
toc
