%CombinedMCCrowdPopModel_OneWFMaxProb
...
%based on v5.2 for both colour and motion
...
ExParam.ColVals = [8 15 165];%[5 30 150]; %the same for colour
...
%free parameters
ModParam.DirNoise     = 0.0229;
ModParam.ColNoise     = 0.0021;
ModParam.LateNoise    = 0.0638;
ModParam.DirWFPosPeak = 0.3126;
ModParam.DirWFPosSD   = 31.2702;
